...
gflags.DEFINE_string('output_frame', None, '[middle/last/all]')
...
gflags.DEFINE_integer('val_overlap', None, 'The overlap (in number of frames) '
                      ...
                      'returned')
gflags_ext.DEFINE_multidict('train_extra_params', {}, 'Dataset train extra params')
gflags_ext.DEFINE_multidict('val_extra_params', {}, 'Dataset valid extra params')
