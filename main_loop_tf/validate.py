...
def save_samples_and_animations(raw_data_gt, raw_data_fw, raw_data_bw, of,
    ...
    ax.set_xticks([])
    ax.set_yticks([])
    ax.imshow(np.squeeze(y), cmap=cmap, vmin=0, vmax=nclasses)  # , cmap=cmap, vmin=0, vmax=nclasses)
    ...
    ax.set_xticks([])
    ax.set_yticks([])
    ax.imshow(np.squeeze(y_pred_mask), cmap=cmap, vmin=0, vmax=nclasses)  # , cmap=cmap, vmin=0, vmax=nclasses)
